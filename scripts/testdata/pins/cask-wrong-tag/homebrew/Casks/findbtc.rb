...
cask "findbtc" do
  ...
  on_linux do
    on_arm do
      ...
      url "https://github.com/pauljones0/findbtc/releases/download/v9.9.9/findbtc_9.9.9_linux_arm64.tar.gz"
    end
    on_intel do
      sha256 "cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc"
      url "https://github.com/pauljones0/findbtc/releases/download/v9.9.8/findbtc_9.9.9_linux_amd64.tar.gz"
    end
  end
